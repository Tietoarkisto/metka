...
<div class="popupContainer" id="timePeriodDialog">
	<h1 class="pageTitle"><spring:message code="study.view.description.collecting.addCollectingDate"/></h1>
	...
	<div class="popupRowHolder">
		<label class="inputRowLabel"><spring:message code="study.view.description.collecting.collectingDateEvent"/></label>
