	...
	<div class="upperContainer">
		...
		<div class="materialDataSetContainer"><label><spring:message code="study.view.depositAgreement.type"/></label>
			...
			<div class="materialDataSetContainer">
				<label class="link"><spring:message code="study.view.depositAgreement.depositAgreementFile"/>&nbsp;<img title="Lis��" class="addRow" id="addFilingContractFile" src="../images/add.png"/></label><input type="text" class="" name="kayttoehto" />
			</div>
