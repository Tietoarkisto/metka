(function () {
	...
	var buildContainertable, buildReferencetable, saveReferenceRow, saveContainerRow;
	 ...
	 */
	buildContainertable = function (content, context) {
	 ...
	 * @param content JSON object, usually from hidden field. Must match type container.
	 */
	buildReferencetable = function (content, context) {
	 ...
	 */
	saveContainerRow = function (row, context) {
		if (row.type !== 'row') {
			return;
		}
	 ...
	 */
	saveReferenceRow = function (reference, context) {
