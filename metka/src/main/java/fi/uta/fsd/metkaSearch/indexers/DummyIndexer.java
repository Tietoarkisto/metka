...
public class DummyIndexer extends Indexer {
    public static DummyIndexer build(DirectoryManager.DirectoryPath path) throws IOException, UnsupportedOperationException {
        ...
        return new DummyIndexer(path);
    }

    private DummyIndexer(DirectoryManager.DirectoryPath path) throws IOException {
        super(path);
    }
