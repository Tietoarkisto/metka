package fi.uta.fsd.metkaSearch.commands.searcher.publication;
...
public final class PublicationBasicSearchCommand extends RevisionSearchCommandBase<RevisionResult> {
    ...
    // TODO: Parameters
    private PublicationBasicSearchCommand(DirectoryManager.DirectoryPath path) throws QueryNodeException {
