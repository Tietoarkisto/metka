...
public final class HandlerFactory {
    public static RevisionHandler buildRevisionHandler(DirectoryInformation indexer, RevisionData data, Configuration config, Pair<Boolean, LocalDateTime> removalInfo) throws UnsupportedOperationException {
        ...
        return new GeneralRevisionHandler(indexer, data, config, removalInfo);
    }
