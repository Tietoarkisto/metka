...
package fi.uta.fsd.metka.spssio.por.input;

// spssio

import fi.uta.fsd.metka.spssio.por.*;
import fi.uta.fsd.metka.spssio.por.PORConstants;
import fi.uta.fsd.metka.spssio.por.PORMatrixVisitor;
import fi.uta.fsd.metka.spssio.por.PORValue;
...
public class PORMatrixParser
{
     ...
     * {@link PORMatrix#accept(PORMatrixVisitor)}.
     */
